...
class MonsterAttributesPerLevel extends GameDataGenerator
{
    ...
    {
        super();
        this.optionsValidator = new MonsterAttributesPerLevelValidator();
    ...
    async generate()
    {
        ...
        return await this.fileHandler.writeFile(this.jsonFileName, JSON.stringify(this.generateMonstersData()));
    }
