...
class PlayersExperiencePerLevel extends GameDataGenerator
{
    ...
    setOptions(options)
    {
        ...
        // optional:
        this.jsonFileName = sc.get(options, 'jsonFileName', 'players-experience-per-level.json');
    ...
    generate()
    {
        ...
        this.fileHandler.writeFile(this.jsonFileName, JSON.stringify(this.calculateLevelExpDynamicGrowth()));
        return true;
    }
