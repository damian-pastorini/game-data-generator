    ...
    generateExperience()
    {
        ...
        for (let levelKey of levelsKeys) {
            ...
            for (let variationKey of variationsKeys) {
                ...
                let newVariationValue = this.calculateVariation(this.variations[variationKey], decrementProportion);
                ...
                if (previousLevel) {
                    ...
                    if(previousExp > newVariationExperience){
                        ...
                        for (let i = 0.9; i >= 0.1; i -= 0.1) {
                            let testDecrementProportion = this.roundToPrecision(decrementProportion * i, 5);
                            ...
                            if (previousExp <= testNewVariationExperience) {
                                ...
                                decrementProportion = testDecrementProportion;
